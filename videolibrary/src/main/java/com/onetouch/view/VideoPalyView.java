...
import com.onetouch.bean.SwitchVideoModel;
...
public class VideoPalyView extends StandardVideoPlayer {
     ...
     */
    public VideoPalyView(Context context, Boolean fullFlag) {
    ...
    public int getLayoutId() {
        return R.layout.video_play_style;
    }
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        VideoPalyView sampleVideo = (VideoPalyView) super.startWindowFullscreen(context, actionBar, statusBar);
    ...
    protected void resolveNormalVideoShow(View oldF, ViewGroup vp, GSYVideoPlayer gsyVideoPlayer) {
        ...
        if (gsyVideoPlayer != null) {
            VideoPalyView sampleVideo = (VideoPalyView) gsyVideoPlayer;
